...
pub const P2P_IN_QUEUE_REQUEST_MAP_SYNC_PROTOCOL: ProtocolId = ProtocolId::new(2);
pub const P2P_IN_QUEUE_REQUEST_MAP_SYNC_PROTOCOL_NAME: &str = "/p2p/in_queue_requests_sync";

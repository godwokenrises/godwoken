...
fn seek_for_prev_with_suffix() {
    ...
    let key_1_with_ver_1_5 = 
        [&key_1[..], &block_num_1.to_be_bytes(), &tx_idx_5.to_be_bytes()]
        .concat();
    assert_eq!(
    ...
    let key_2_with_ver_2_7 = 
        [&key_2[..], &block_num_2.to_be_bytes(), &tx_idx_7.to_be_bytes()]
        .concat();
    assert_eq!(
    ...
    let key_3_with_ver_256_2 = 
        [&key_3[..], &block_num_256.to_be_bytes(), &tx_idx_2.to_be_bytes()]
        .concat();
    assert_eq!(
    ...
    let key_3_with_ver_257_1 = 
        [&key_3[..], &257u64.to_be_bytes(), &9u32.to_be_bytes()]
        .concat();
    let key_3_with_ver_256_9 = 
        [&key_3[..], &block_num_256.to_be_bytes(), &9u32.to_be_bytes()]
        .concat();
    let key_3_with_ver_256_1 = 
        [&key_3[..], &block_num_256.to_be_bytes(), &1u32.to_be_bytes()]
        .concat();
    let key_2_with_ver_2_6 = 
        [&key_2[..], &block_num_2.to_be_bytes(), &6u32.to_be_bytes()]
        .concat();
    let key_1_with_ver_1_4 = 
        [&key_1[..], &block_num_1.to_be_bytes(), &4u32.to_be_bytes()]
        .concat();
    ...
    assert_eq!(
        &value_2, 
        raw_iter.value().unwrap()
    );
    assert_ne!(
        key_3, 
        raw_iter.key().unwrap()[..n-12]
    );
